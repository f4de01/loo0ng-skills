...
class MainGuardTests(RepoCase, unittest.TestCase):
    ...
    def test_preset_graph_on_main_is_rejected(self):
        rel = "skills/engineering/domain/assets/预设图/破产/预设图.json"
        self.write(rel, '{"模块": []}\n')
        self.git("add", "skills")
        code, out = self.check("--staged")
        self.assertRejected(code, out)
    ...
    def test_preset_templates_on_main_pass(self):
        rel = "skills/engineering/domain/assets/预设图/破产/模板/说明.md"
